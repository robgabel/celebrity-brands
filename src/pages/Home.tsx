...
const sortOptions: SortOption[] = [
  { value: 'az', label: 'Brand Name (A to Z)', field: 'name', ascending: true },
  { value: 'newest', label: 'Year Founded (Newest)', field: 'year_founded', ascending: false },
  { value: 'oldest', label: 'Year Founded (Oldest)', field: 'year_founded', ascending: true }
];
...
export function HomePage() {
  ...
  const [founderFilter, setFounderFilter] = useState('All Founder Types');
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-2 text-gray-100">
                Rob's List: Celebrity & Creator Brands
              </h1>
                          ...
                          <td className="px-3 py-4">
                            <div className="flex items-center space-x-3">
                              <div className={`w-8 h-8 flex-shrink-0 flex items-center justify-center rounded-lg ${categoryColors.bg} ${categoryColors.text}`}>
                                {getCategoryIcon(brand.product_category)}
                              </div>
